# 1 ".././../module_xtcp.1v3/src/uip/apps/autoip/autoip.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 ".././../module_xtcp.1v3/src/uip/apps/autoip/autoip.c"
# 20 ".././../module_xtcp.1v3/src/uip/apps/autoip/autoip.c"
...
# 21 ".././../module_xtcp.1v3/src/uip/apps/autoip/autoip.c" 2
...
# 22 ".././../module_xtcp.1v3/src/uip/apps/autoip/autoip.c" 2
...
# 23 ".././../module_xtcp.1v3/src/uip/apps/autoip/autoip.c" 2
# 1 ".././../module_xtcp.1v3/src/uip/uip/timer.h" 1
# 24 ".././../module_xtcp.1v3/src/uip/apps/autoip/autoip.c" 2
# 1 ".././../module_xtcp.1v3/src/uip/xcore/clock-arch.h" 1
# 25 ".././../module_xtcp.1v3/src/uip/apps/autoip/autoip.c" 2
...
# 26 ".././../module_xtcp.1v3/src/uip/apps/autoip/autoip.c" 2
...
# 27 ".././../module_xtcp.1v3/src/uip/apps/autoip/autoip.c" 2
...
# 74 ".././../module_xtcp.1v3/src/uip/apps/autoip/autoip.c"
...
{
  long long x;
  do {autoip_state->rand = a*autoip_state->rand+c;} while (0);
...
{
  create_arp_packet();
  do { ((u16_t *)((struct arp_hdr *)&uip_buf[0])->dipaddr)[0] = ((u16_t *)autoip_state->ipaddr)[0]; ((u16_t *)((struct arp_hdr *)&uip_buf[0])->dipaddr)[1] = ((u16_t *)autoip_state->ipaddr)[1]; } while(0);
  ((struct arp_hdr *)&uip_buf[0])->sipaddr[0] = 0;
  ((struct arp_hdr *)&uip_buf[0])->sipaddr[1] = 0;
...
static void send_announce()
{
  create_arp_packet();
  do { ((u16_t *)((struct arp_hdr *)&uip_buf[0])->dipaddr)[0] = ((u16_t *)autoip_state->ipaddr)[0]; ((u16_t *)((struct arp_hdr *)&uip_buf[0])->dipaddr)[1] = ((u16_t *)autoip_state->ipaddr)[1]; } while(0);
  do { ((u16_t *)((struct arp_hdr *)&uip_buf[0])->sipaddr)[0] = ((u16_t *)autoip_state->ipaddr)[0]; ((u16_t *)((struct arp_hdr *)&uip_buf[0])->sipaddr)[1] = ((u16_t *)autoip_state->ipaddr)[1]; } while(0);

  autoip_state->announces_sent++;
  timer_set(&autoip_state->timer, 2 * 1000);
}
    ...
    case NO_ADDRESS:
      {
        ...
        if (!autoip_state->limit_rate || timer_expired(&autoip_state->timer)) {
          ...
          do { ((u16_t *)(&(autoip_state->ipaddr)))[0] = (u16_t)((((u16_t) (((169) << 8) | (254))) << 8) | (((u16_t) (((169) << 8) | (254))) >> 8)); ((u16_t *)(&(autoip_state->ipaddr)))[1] = (u16_t)((((u16_t) (((r1) << 8) | (r2))) << 8) | (((u16_t) (((r1) << 8) | (r2))) >> 8)); } while(0);
          autoip_state->state = WAIT_FOR_PROBE;
          random_timer_set(&autoip_state->timer, 0, 1 * 1000);
        }
        break;
      }
    case WAIT_FOR_PROBE:
      ...
      if (timer_expired(&autoip_state->timer)) {
        if (autoip_state->num_conflicts == 0) {
          ...
          autoip_state->limit_rate =
            autoip_state->limit_rate ||
            (autoip_state->num_conflicts > 10);
          timer_set(&autoip_state->timer, 60 * 1000);
        }
      }
      break;
    case ANNOUNCING:
      send_announce();
      if (autoip_state->announces_sent == 2) {
  ...
  switch (autoip_state->state)
    {
      ...
      case PROBING:
      case WAIT_FOR_ANNOUNCE:
        if ((((u16_t *)((struct arp_hdr *)&uip_buf[0])->sipaddr)[0] == ((u16_t *)autoip_state->ipaddr)[0] && ((u16_t *)((struct arp_hdr *)&uip_buf[0])->sipaddr)[1] == ((u16_t *)autoip_state->ipaddr)[1])) {

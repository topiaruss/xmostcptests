# 1 ".././../module_xtcp.1v3/src/uip/uip/uip-split.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 ".././../module_xtcp.1v3/src/uip/uip/uip-split.c"
# 55 ".././../module_xtcp.1v3/src/uip/uip/uip-split.c"
...
# 56 ".././../module_xtcp.1v3/src/uip/uip/uip-split.c" 2

# 1 ".././../module_xtcp.1v3/src/uip/uip/uip-split.h" 1
# 93 ".././../module_xtcp.1v3/src/uip/uip/uip-split.h"
...
# 94 ".././../module_xtcp.1v3/src/uip/uip/uip-split.h" 2
# 110 ".././../module_xtcp.1v3/src/uip/uip/uip-split.h"
void uip_split_output(chanend mac_tx);
# 58 ".././../module_xtcp.1v3/src/uip/uip/uip-split.c" 2
...
# 59 ".././../module_xtcp.1v3/src/uip/uip/uip-split.c" 2
...
u16_t uip_udpchksum(void);
# 61 ".././../module_xtcp.1v3/src/uip/uip/uip-split.c" 2
...
# 64 ".././../module_xtcp.1v3/src/uip/uip/uip-split.c" 2
...
# 65 ".././../module_xtcp.1v3/src/uip/uip/uip-split.c" 2
...
uip_split_output(chanend mac_tx)
{
  ...
  if(((struct uip_tcpip_hdr *)&uip_buf[14])->proto == 6 &&
    ...
    ((struct uip_tcpip_hdr *)&uip_buf[14])->seqno[0] = uip_acc32[0];
    ((struct uip_tcpip_hdr *)&uip_buf[14])->seqno[1] = uip_acc32[1];
    ((struct uip_tcpip_hdr *)&uip_buf[14])->seqno[2] = uip_acc32[2];
    ((struct uip_tcpip_hdr *)&uip_buf[14])->seqno[3] = uip_acc32[3];

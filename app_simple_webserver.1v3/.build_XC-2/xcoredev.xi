# 1 ".././../module_xtcp.1v3/src/uip/xcore/xcoredev.xc"
# 20 ".././../module_xtcp.1v3/src/uip/xcore/xcoredev.xc"
# 1 "print.h" 1 3
# 34 "print.h" 3
...
# 21 ".././../module_xtcp.1v3/src/uip/xcore/xcoredev.xc" 2
# 1 "xs1.h" 1 3
# 31 "xs1.h" 3
...
# 22 ".././../module_xtcp.1v3/src/uip/xcore/xcoredev.xc" 2
...
# 25 ".././../module_xtcp.1v3/src/uip/xcore/xcoredev.xc" 2
# 30 ".././../module_xtcp.1v3/src/uip/xcore/xcoredev.xc"
...
xcoredev_init(chanend rx, chanend tx)
{
  ...
  mac_get_macaddr(tx, mac_addr);
   ...
   filter. opcode  =  0x80000081 ;
   for (i = 0; i <  6 ; i++)
   {
      filter. dmac_msk [i] = 0xff;
      filter. dmac_val [i] = 0x0;
      switch (i)
        {
        case 0:
          filter. vlan_msk [i] = 0xff;
          filter. vlan_val [i] = 0x08;
          break;
        case 1:
          filter. vlan_msk [i] = 0xff;
          filter. vlan_val [i] = 0x06;
          break;
        default:
          filter. vlan_msk [i] = 0;
          filter. vlan_val [i] = 0;
   ...
   result =  mac_set_filter (rx, 0, filter);
   ...
   result =  mac_set_filter (rx, 1, filter);


}
# 108 ".././../module_xtcp.1v3/src/uip/xcore/xcoredev.xc"
...
xcoredev_read(chanend rx, int n)
{
  ...
  select
    {
    case  __builtin_in_uchar_byref(rx, tmp) :
      (void)  __builtin_in_uchar(rx) ;
      (void)  __builtin_in_uchar(rx) ;
      (void)  __builtin_inct(rx) ;
      master {
        rx <:  (0x80000010) ;
      }
      slave {

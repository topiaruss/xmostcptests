# 1 ".././../module_ethernet.1v3/src/client/ethernet_tx_client.xc"
# 31 ".././../module_ethernet.1v3/src/client/ethernet_tx_client.xc"
# 1 "xs1.h" 1 3
# 31 "xs1.h" 3
...
# 32 ".././../module_ethernet.1v3/src/client/ethernet_tx_client.xc" 2
# 1 "ethernet_server_def.h" 1
# 33 "ethernet_server_def.h"
# 1 "ethernet_conf.h" 1
# 34 "ethernet_server_def.h" 2
# 33 ".././../module_ethernet.1v3/src/client/ethernet_tx_client.xc" 2
...
# 34 ".././../module_ethernet.1v3/src/client/ethernet_tx_client.xc" 2
# 43 ".././../module_ethernet.1v3/src/client/ethernet_tx_client.xc"
...
# 76 ".././../module_ethernet.1v3/src/client/ethernet_tx_client.xc"
...
# 95 ".././../module_ethernet.1v3/src/client/ethernet_tx_client.xc"
void mac_tx_timed(chanend ethernet_tx_svr, unsigned int Buf[], int count, unsigned int &sentTime, int ifnum)
{
  ethernet_send_frame_unify(ethernet_tx_svr, Buf, count, sentTime,  (0x80000001) , ifnum);
  return;
}
# 108 ".././../module_ethernet.1v3/src/client/ethernet_tx_client.xc"
int mac_get_macaddr(chanend ethernet_tx_svr, unsigned char Buf[])
{
  int i;


  ethernet_tx_svr <:  (0x80000002) ;
